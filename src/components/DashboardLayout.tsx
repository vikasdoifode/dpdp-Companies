...
const NAV_ITEMS = [
  { to: "/dashboard", icon: LayoutDashboard, label: "Compliance Dashboard" },
  { to: "/companies", icon: Building2, label: "Company Profile" },
  { to: "/consent-logs", icon: ShieldAlert, label: "Consent Logs" },
  { to: "/sdk-integration", icon: Code2, label: "SDK Integration" },
  { to: "/blockchain-audit", icon: Layers, label: "Blockchain Audit" },
      ...
      <header className="sticky top-0 z-50 h-16 border-b bg-blue-50/80 backdrop-blur-xl flex items-center px-6 md:px-10 justify-between shrink-0">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden md:flex flex-col items-end">
            ...
            <span className="text-[10px] font-medium text-slate-500">{company?.email}</span>
          </div>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-64 p-2 rounded-[1.5rem] mt-2 shadow-2xl border-blue-100 bg-blue-50/95 backdrop-blur-xl animate-in fade-in zoom-in-95" align="end">
              <DropdownMenuLabel className="px-4 py-3">
                ...
                <p className="text-[10px] font-medium text-slate-400">{company?.email}</p>
              </DropdownMenuLabel>
              ...
              <DropdownMenuGroup>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-black tracking-tight">Company Profile</span>
                  </div>
