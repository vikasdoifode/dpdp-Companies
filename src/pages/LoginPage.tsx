          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                variant="outline"
                type="button"
                className="w-full bg-card hover:bg-muted/50 transition-colors"
                onClick={() =>
                  alert(
                    "Social authentication would be handled via backend integration here.",
                  )
                }
              >
            ...
            <div className="mt-4 flex items-center justify-center gap-1.5 text-xs text-muted-foreground">
              ...
              <span>Data Fiduciary compliance under DPDP Act 2023</span>
            </div>
          </CardContent>
        </Card>
      </div>
